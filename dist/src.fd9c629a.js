...
"use strict";var e=t(require("@babel/runtime-corejs3/core-js-stable/instance/reverse")),o=t(require("@babel/runtime-corejs3/helpers/toConsumableArray")),n=t(require("@babel/runtime-corejs3/core-js-stable/instance/for-each"));function t(e){return e&&e.__esModule?e:{default:e}}function a(){var t,a=document.querySelector("#open"),i=document.querySelector("#close"),r=gsap.timeline({paused:!0,reversed:!0});a.addEventListener("click",function(){console.log("hello"),r.reversed()&&r.play(),r.to("#open",{display:"none"}).to("#close",{display:"inline-block"}).to(".nav_container",{display:"inline-block"}).to(".box",{scale:1,stagger:.2,transformOrigin:"top"}).from("nav ul li",{x:100,opacity:0,stagger:.2})}),(0,n.default)(t=(0,o.default)(document.querySelectorAll("nav ul li"))).call(t,function(o){return o.addEventListener("click",function(){(0,e.default)(r).call(r)})}),i.addEventListener("click",function(){(0,e.default)(r).call(r)})}function i(){var e=gsap.timeline();console.log("landing page should be working na "),e.to(".loader_container",{opacity:0,duration:2,delay:2}).to(".loader_container",{display:"none"}).to(".welcome_conatainer div",{duration:1,text:{value:"SHOPPER",delimiter:""},ease:"power2",delay:-.25}).to(".welcome_conatainer",{opacity:0,duration:2,delay:2}).to(".welcome_conatainer",{display:"none"}).from(".img_section",{scaleX:0,transformOrigin:"left"}).from(".text_section",{opacity:0,scaleX:0,transformOrigin:"right",zIndex:"-1"}).from("#img1",{opacity:"0",y:-100}).from("#img2",{opacity:"0",x:100}).from("#img3",{opacity:"0",x:-100}).from(".text_section .home",{opacity:"0",x:-100})}require("./sass/main.scss"),require("./sass/main.scss"),document.body.onload=function(){a(),i()};
...
//# sourceMappingURL=src.fd9c629a.js.map